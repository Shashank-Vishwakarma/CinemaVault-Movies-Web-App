...
import { History, LogOut, Menu, Search } from "lucide-react";
        ...
        <header className='max-w-6xl mx-auto flex flex-wrap items-center justify-between p-4 h-20'>
            <div className='flex items-center gap-10 z-50'>
                <Link to='/' className="flex gap-4 items-center">
                    <img src='/logo.png' alt='CinemaVault Logo' className='w-16' />
            ...
            <div className='flex gap-8 items-center z-50'>
                ...
                <History className="cursor-pointer" onClick={() => navigateTo('/search/history')} />
