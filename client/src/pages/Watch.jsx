...
import { ORIGINAL_IMG_BASE_URL, SMALL_IMG_BASE_URL } from "../constants/constants.js";
            ...
            <div className='mx-auto container px-4 py-8 h-full'>
                ...
                {similarContent?.length > 0 && (
                    <div className='mt-12 max-w-5xl mx-auto relative'>
                        ...
                        <div className='flex overflow-hidden scrollbar-hide gap-4 pb-4 group' ref={sliderRef}>
